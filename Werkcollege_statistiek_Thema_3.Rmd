...
```{r}
d$verwachtFEV1 <- ifelse(d$Geslacht == "V",
                         3.95 * d$Lengte - 0.025 * d$Leeftijd - 2.60,
                         4.30 * d$Lengte - 0.029 * d$Leeftijd - 2.49)
...
# sweep(dtab, 1, rowSums(dtab), "/")

sweep(dtab, 2, margin.table(dtab, 2), "/")
# sweep(dtab, 2, colSums(dtab), "/")
```
