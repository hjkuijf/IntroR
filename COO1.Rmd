...
4. In the **plots and files** panel, you can find 'files', 'plots', 'list of packages', 'help' and 'viewer'. 
...
If you can't remember which arguments to use in a function, you can use the 'Help' pages in RStudio. You can do this by clicking on 'Help' in the 'Plots and files' panel and search with the search bar, or you can use the command `help(functionname)` or `?functionname`.  An explanation of how to read the 'Help' pane can be found [here](https://robwschlegel.github.io/Intro_R_Workshop/workflow.html#help).
An example:
```{r eval=FALSE}
?seq
```
